            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const CircleAvatar(
                  ...
                  child: Icon(Icons.spa_outlined, size: 40, color: PrimaryAccent),
                ),
                ...
                if (_errorMessage != null)
                  Padding(
                    ...
                    child: Text(_errorMessage!, style: const TextStyle(color: ErrorRed, fontWeight: FontWeight.bold)),
                  ),
                ...
                TextButton(
                  ...
                  child: const Text("Don't have an account? Register", style: TextStyle(color: TextColor, fontWeight: FontWeight.w600)),
                ),
                const SizedBox(height: 20),
              ],
            ),
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _isLoading ? const CircularProgressIndicator(color: Colors.white, strokeWidth: 2) : const Text('Login', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
          ),
        ],
      ),
